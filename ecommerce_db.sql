...
--  DELETE: order_id = 9 deleted first (no FK conflict)
DELETE FROM Orders WHERE order_id = 9;

--  DELETE: customer_id = 10 (Fatou Diallo has no orders → safe to delete)
DELETE FROM Customers WHERE customer_id = 10;

-- ============================================================
-- 9. REFERENTIAL INTEGRITY TEST (FOR PRESENTATION)
-- ============================================================

--  STEP 1 — Verify customer 999 does NOT exist
SELECT * FROM Customers WHERE customer_id = 999;
-- Expected result: empty (0 rows)

--  STEP 2 — Try to insert an order for a non-existent customer
--    This will INTENTIONALLY FAIL to demonstrate referential integrity
--    Expected error: Error Code 1452 — FK constraint violation
INSERT INTO Orders (customer_id, total_amount) VALUES (999, 100);

--  STEP 3 — Correct version: insert with a valid customer_id
